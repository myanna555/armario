...
import com.android.gatofalante.armario.activities.dummy.DummyContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Replace with your own action cat list activ", Snackbar.LENGTH_LONG)
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(CategoryDetailFragment.ARG_ITEM_ID, holder.mItem.getListItem());
                        ...
                        intent.putExtra(CategoryDetailFragment.ARG_ITEM_ID, holder.mItem.getListItem());
